...
import { cleanCart, decrementQnt, incrementQnt } from "../../redux/CartSlice";
  ...
  return (
    <>
      <ScrollView style={{ padding: 10, flex: 1, backgroundColor: "#F0F8FF" }}>
        ...
        >
            <MaterialCommunityIcons name="clock-time-four-outline" size={24} color="green" />
          <Text>
